...
type UpdateStateRequest struct {
	...
	State    *commonpb.State `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`
...
func (x *UpdateStateRequest) GetState() *commonpb.State {
	if x != nil {
		return x.State
	}
	return nil
...
var file_node_proto_rawDesc = []byte{
	...
	0x22, 0x6a, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x06, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73,
	...
	0x01, 0x28, 0x0d, 0x52, 0x07, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x49, 0x64, 0x22, 0x32, 0x0a, 0x13,
	...
	,
}
...
var file_node_proto_goTypes = []interface{}{
	...
	(*commonpb.State)(nil),      // 2: State
	(*commonpb.Replay)(nil),     // 3: Replay
}
var file_node_proto_depIdxs = []int32{
	2, // 0: node.UpdateStateRequest.state:type_name -> State
	...
	3, // 3: node.Node.UpdateState:output_type -> Replay
	3, // 4: node.Node.DeleteDevice:output_type -> Replay
...
type NodeClient interface {
	UpdateState(ctx context.Context, in *UpdateStateRequest, opts ...grpc.CallOption) (*commonpb.Replay, error)
	DeleteDevice(ctx context.Context, in *DeleteDeviceRequest, opts ...grpc.CallOption) (*commonpb.Replay, error)
}
...
func (c *nodeClient) UpdateState(ctx context.Context, in *UpdateStateRequest, opts ...grpc.CallOption) (*commonpb.Replay, error) {
...
func (c *nodeClient) DeleteDevice(ctx context.Context, in *DeleteDeviceRequest, opts ...grpc.CallOption) (*commonpb.Replay, error) {
	out := new(commonpb.Replay)
...
type NodeServer interface {
	UpdateState(context.Context, *UpdateStateRequest) (*commonpb.Replay, error)
	DeleteDevice(context.Context, *DeleteDeviceRequest) (*commonpb.Replay, error)
}
...
func (*UnimplementedNodeServer) UpdateState(context.Context, *UpdateStateRequest) (*commonpb.Replay, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateState not implemented")
}
func (*UnimplementedNodeServer) DeleteDevice(context.Context, *DeleteDeviceRequest) (*commonpb.Replay, error) {
