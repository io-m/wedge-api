...
func (x *UpdateStateRequest) GetState() *slx.State {
	if x != nil {
		return x.State
	}
	return nil
...
var file_node_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x1a, 0x09, 0x73, 0x6c, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6a, 0x0a,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x12, 0x19,
	0x0a, 0x08, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x07, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x49, 0x64, 0x22, 0x32, 0x0a, 0x13, 0x44, 0x65, 0x6c,
	...
	,
}
...
var file_node_proto_goTypes = []interface{}{
	...
	(*slx.State)(nil),           // 2: State
	(*slx.Replay)(nil),          // 3: Replay
}
...
type NodeClient interface {
	UpdateState(ctx context.Context, in *UpdateStateRequest, opts ...grpc.CallOption) (*slx.Replay, error)
	DeleteDevice(ctx context.Context, in *DeleteDeviceRequest, opts ...grpc.CallOption) (*slx.Replay, error)
}
...
func (c *nodeClient) UpdateState(ctx context.Context, in *UpdateStateRequest, opts ...grpc.CallOption) (*slx.Replay, error) {
	out := new(slx.Replay)
...
func (c *nodeClient) DeleteDevice(ctx context.Context, in *DeleteDeviceRequest, opts ...grpc.CallOption) (*slx.Replay, error) {
	out := new(slx.Replay)
...
type NodeServer interface {
	UpdateState(context.Context, *UpdateStateRequest) (*slx.Replay, error)
	DeleteDevice(context.Context, *DeleteDeviceRequest) (*slx.Replay, error)
}
...
func (*UnimplementedNodeServer) UpdateState(context.Context, *UpdateStateRequest) (*slx.Replay, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateState not implemented")
}
func (*UnimplementedNodeServer) DeleteDevice(context.Context, *DeleteDeviceRequest) (*slx.Replay, error) {
