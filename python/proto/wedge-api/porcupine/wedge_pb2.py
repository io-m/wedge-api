...
NodeIdentity = _reflection.GeneratedProtocolMessageType('NodeIdentity', (_message.Message,), dict(
...
GetControlRequest = _reflection.GeneratedProtocolMessageType('GetControlRequest', (_message.Message,), dict(
...
DeleteDevice = _reflection.GeneratedProtocolMessageType('DeleteDevice', (_message.Message,), dict(
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z%github.com/Wappsto/wedge-api/go/wedge'))
